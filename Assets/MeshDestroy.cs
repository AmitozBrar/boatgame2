...
public class MeshDestroy : MonoBehaviour
{
    ...
    private void DestroyMesh()
    {
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            //this.transform.parent = new parent object
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            var floating =  GameObject.AddComponent<Floater>();
            floating.rigidBodyFloat = rigidbody;
            floating.depthBeforeSubmerged = 0.2f;
            floating.floaterCount = 4.0f;
